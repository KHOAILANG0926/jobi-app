...
/* ?Ä?Ä Static data ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */
...
const CITY_BUTTONS: { id: JobRegionId; label: string }[] = [
  ...
  { id: 'hcm',        label: 'TP. HCM' },
  { id: 'danang',     label: 'ƒê√† N·∫µng' },
  { id: 'binhduong',  label: 'B√¨nh D∆∞∆°ng' },
  { id: 'bacninh',    label: 'B·∫Øc Ninh' },
  { id: 'haiphong',   label: 'H·∫£i Ph√≤ng' },
  { id: 'dongnai',    label: 'ƒê·ªìng Nai' },
  { id: 'cantho',     label: 'C·∫ßn Th∆°' },
  { id: 'hunguyen',   label: 'H∆∞ng Y√™n' },
  { id: 'thainguyen', label: 'Th√°i Nguy√™n' },
  { id: 'vinhphuc',   label: 'Vƒ©nh Ph√∫c' },
  { id: 'bacgiang',   label: 'B·∫Øc Giang' },
  { id: 'haiduong',   label: 'H·∫£i D∆∞∆°ng' },
]

/* ?Ä?Ä Ad slot (replace <div className="ad-slot__ph"> with real ad code) */

const AD_CONFIGS = {
  header: {
    bg: 'linear-gradient(135deg,#667eea 0%,#764ba2 100%)',
    icon: '?éì',
    eyebrow: 'Kh√≥a h·ªçc k·ª?nƒÉng ngh·ª?,
    headline: 'N√¢ng cao k·ª?nƒÉng ??tƒÉng l∆∞∆°ng ngay',
    sub: 'H∆°n 200 kh√≥a h·ªçc ch·ª©ng ch·ª?ngh·ª?tr·ª±c tuy·∫øn',
  ...
  mid: {
    ...
    icon: '?è¢',
    eyebrow: 'D√†nh cho nh√† tuy·ªÉn d·ª•ng',
    headline: 'T√¨m ·ª©ng vi√™n ch·∫•t l∆∞·ª£ng cao',
    sub: 'ƒêƒÉng tin mi·ªÖn ph√≠ ??Ti·∫øp c·∫≠n 50.000+ ·ª©ng vi√™n',
    cta: 'ƒêƒÉng tin ngay ??,
    light: true,
  },
  inline: {
    ...
    icon: '?ì±',
    headline: 'T·∫£i app Vi·ªác g·∫ßn B·∫°n ??Nh·∫≠n vi·ªác l√†m tr√™n di ƒë·ªông',
    cta: 'T·∫£i ngay mi·ªÖn ph√≠ ??,
    light: false,
  },
}
...
/* ?Ä?Ä Brand logo with image + initial fallback ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */
...
/* ?Ä?Ä Main component ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */
...
export function Home() {
  ...
  const handleNearMe = useCallback(() => {
    ...
    if (!navigator.geolocation) { setGeoError('Tr√¨nh duy·ªát kh√¥ng h·ª?tr·ª?ƒë·ªãnh v·ª?'); return }
    setGeoLoading(true); setGeoError(null)
    navigator.geolocation.getCurrentPosition(
      (pos) => { setUserCoords({ lat: pos.coords.latitude, lng: pos.coords.longitude }); setNearMe(true); setGeoLoading(false) },
      () => { setGeoError('Kh√¥ng th·ª?l·∫•y v·ª?tr√≠.'); setGeoLoading(false) },
      { timeout: 10_000 },
    )
  }, [nearMe, userCoords])
  ...
  return (
    <div className="home-page">
      ...
      {/* ?Ä?Ä Banner ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */}
      <HomeBanner />

      {/* ?Ä?Ä Ad slot 1: Header ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */}
      <AdSlot slotId="header" />

      {/* ?Ä?Ä Search ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */}
      <div className="home-search-wrap">
        <div className="home-search">
          ...
          <input
            ...
            placeholder="T√¨m vi·ªác l√†m, c√¥ng ty, ƒë·ªãa ƒëi·ªÉm..."
            value={search}
            onChange={(e) => setSearch(e.target.value)}
            aria-label="T√¨m ki·∫øm vi·ªác l√†m"
          />
          {search && <button className="home-search__clear" onClick={() => setSearch('')} aria-label="X√≥a">??/button>}
        </div>
      </div>

      {/* ?Ä?Ä City button grid ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */}
      <section className="city-grid" aria-label="L·ªçc theo th√†nh ph·ª?>
        <div className="city-grid__head">
          <span className="city-grid__icon">?ìç</span>
          <h2 className="city-grid__title">T√¨m vi·ªác theo khu v·ª±c</h2>
        </div>
        <div className="city-grid__buttons">
          ...
          >
            <span className="city-btn__label">?åê T·∫•t c·∫?/span>
      ...
      {/* ?Ä?Ä City filtered results ??right below city buttons ?Ä?Ä?Ä?Ä */}
      {selectedCity && (() => {
          ...
          <section className="city-result" ref={cityResultRef}>
            <div className="city-result__head">
              <div className="city-result__title-wrap">
                <span className="city-result__pin">?ìç</span>
                <h2 className="city-result__title">Vi·ªác l√†m t·∫°i {cityLabel}</h2>
                <span className="city-result__count">{filtered.length} k·∫øt qu·∫?/span>
              </div>
            ...
            {filtered.length === 0 ? (
              <div className="city-result__empty">
                <span>?îç</span>
                <p>Ch∆∞a c√≥ vi·ªác l√†m t·∫°i <strong>{cityLabel}</strong></p>
                <button onClick={() => setSelectedCity(null)}>??Xem t·∫•t c·∫?/button>
              </div>
            ) : (
              <>
                {urgentJobs.length > 0 && (
      ...
      {/* ?Ä?Ä Category grid ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */}
      <section className="home-cat-grid" aria-label="L·ªçc theo ng√†nh ngh·ª?>
        <button
        ...
        >
          ...
          <span className="home-cat-card__label">T·∫•t c·∫?/span>
      ...
      {/* ?Ä?Ä Featured brands ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */}
      <section className="home-brands">
        <div className="home-brands__head">
          <h2 className="home-brands__title">?è¢ Nh√† tuy·ªÉn d·ª•ng n·ªïi b·∫≠t</h2>
          <span className="home-brands__sub">Nh·∫•n ƒë·ª?l·ªçc</span>
        </div>
      ...
      {/* ?Ä?Ä Ad slot 2: Mid ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */}
      <AdSlot slotId="mid" />

      {/* ?Ä?Ä Promo strip ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */}
      {!hasFilters && (
        <div className="home-promo">
          <div className="home-promo__content">
            <span className="home-promo__icon">?ìã</span>
            <div>
              <p className="home-promo__title">T·∫°o CV ngay ??tƒÉng c∆° h·ªôi ƒë∆∞·ª£c g·ªçi!</p>
              <p className="home-promo__sub">Nh√† tuy·ªÉn d·ª•ng t√¨m ki·∫øm CV m·ªói ng√†y.</p>
            </div>
          </div>
          <button className="home-promo__btn" onClick={() => navigate('/ho-so')}>T·∫°o CV mi·ªÖn ph√≠ ??/button>
        </div>
      )}

      {/* ?Ä?Ä Filter bar ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */}
      <div className="home-filter-bar">
        <span className="home-result-count">
          {selectedCity
            ? `${filtered.length} vi·ªác l√†m t·∫°i ${CITY_BUTTONS.find(c => c.id === selectedCity)?.label}`
            : hasFilters
        ...
        <button
          ...
          aria-pressed={nearMe}
        >
          {geoLoading ? 'ƒêang ƒë·ªãnh v·ª?..' : '?ìç G·∫ßn t√¥i'}
        </button>
        {hasFilters && <button className="home-reset-btn" onClick={resetFilters}>??X√≥a l·ªçc</button>}
      </div>

      {nearMe && userCoords && (
        <div className="home-radius-wrap" role="group" aria-label="B√°n k√≠nh">
          {[1, 3, 5, 10].map(r => (
      ...
      {/* ?Ä?Ä Bottom job section: only when NO city is selected ?Ä?Ä?Ä?Ä */}
      {!selectedCity && (
        <>
          ...
          {hasOtherFilters && filtered.length === 0 ? (
            <div className="home-empty">
              <span className="home-empty__icon">?îç</span>
              <p className="home-empty__text">Kh√¥ng t√¨m th·∫•y vi·ªác l√†m ph√π h·ª£p</p>
              <button className="home-empty__reset" onClick={resetFilters}>X√≥a b·ª?l·ªçc</button>
            </div>
          ) : nearMe && userCoords ? (
            <JobGrid jobs={filtered} title="?ìç Vi·ªác l√†m g·∫ßn b·∫°n" />
          ) : (
            <>
              {!urgentOnly && urgentJobs.length > 0 && (
                <JobGrid jobs={urgentJobs} title="?î• Tuy·ªÉn g·∫•p" />
              )}
              ...
              {(urgentOnly ? filtered : regularJobs).length > 0 && (
                <JobGrid
                  ...
                  title={(!urgentOnly && urgentJobs.length > 0) ? '?ìã T·∫•t c·∫?k·∫øt qu·∫? : undefined}
                />
              )}
            </>
          )}
      ...
      {/* ?Ä?Ä Stats & Ad Inquiry Section ?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä?Ä */}
      <section style={{
        margin: '32px 0 16px',
        borderRadius: '16px',
        overflow: 'hidden',
